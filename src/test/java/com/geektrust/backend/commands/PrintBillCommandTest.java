...
class PrintBillCommandTest {
    ...
    @Test
    void execute() {
        BillPrintDto billPrintDto = new BillPrintDto(1000, DiscountCoupons.NONE, 0, 100, 100, 500, 1600);
        when(billingService.calculateBill()).thenReturn(billPrintDto);
    ...
    @Test
    void execute1() {
        BillPrintDto billPrintDto = new BillPrintDto(1000, DiscountCoupons.DEAL_G20, 20, 100, 100, 500, 1580);
        when(billingService.calculateBill()).thenReturn(billPrintDto);
        printBillCommand.execute(Collections.emptyList());
