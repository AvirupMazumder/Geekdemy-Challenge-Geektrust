...
public class BillPrintDto {
    ...
    public BillPrintDto(double totalProgrammeFee, DiscountCoupons couponDiscountType, double couponDiscountAmount, double proMembershipDiscount, double proMembershipFee, double enrollmentFee, double total) {
